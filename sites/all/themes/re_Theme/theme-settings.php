 ...
 *   The form state.
 */
function re_Theme_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','re_Theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 're_Theme'),
  ...
  $form['prof_settings']['top_social_link']['twitter_username'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_username', 're_Theme'),
  ...
  $form['prof_settings']['top_social_link']['facebook_username'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_username', 're_Theme'),
