...
<div id="header_wrapper">
  <div id="inner_header_wrapper">
    ...
    <?php if (theme_get_setting('social_links', 're_Theme')): ?>
      <div class="social-icons">
       <ul>
        <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 're_Theme') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 're_Theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 're_Theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
        <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 're_Theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 're_Theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
       </ul>
      </div>
    <?php endif; ?>
...
<header id="header" role="banner">
  ...
  <div id="container">
    ...
    <div id="content">
      <?php if (theme_get_setting('breadcrumbs', 're_Theme')): ?><div id="breadcrumbs"><?php if ($breadcrumb): print $breadcrumb; endif;?></div><?php endif; ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?> </p> <p class="credits"> <?php print t('Designed by'); ?>  <a href="http://eduprosolutions.com">EDUPRO</a></p>
    <div class="clear"></div>
    </div>
  </div>
  </div>
